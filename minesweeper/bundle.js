...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = __webpack_require__(168);
	
	var MinesweeperGame = React.createClass({
	  displayName: 'MinesweeperGame',
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(MinesweeperGame, null), document.getElementById('main'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Minesweeper = __webpack_require__(169);
	...
	var Game = React.createClass({
	  ...
	  updateGame: function updateGame(tile, altKeyDown) {
	    if (altKeyDown) {
	      tile.toggleFlag();
	    } else {
	      tile.explore();
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'newGame', onClick: this.restartGame },
	        'New Game'
	      )
	    );
	  }
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.props.board.grid.map(function (row, i) {
	          return React.createElement(
	            'div',
	            { key: i, id: i, className: 'row' },
	            row.map(function (tile, j) {
	              var pos = [i, j];
	              return React.createElement(Tile, { tile: tile, key: pos, updateGame: _this.props.updateGame });
	            })
	          );
	        })
	      )
